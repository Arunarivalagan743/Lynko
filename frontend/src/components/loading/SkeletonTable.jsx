...
export default function SkeletonTable({ variant = 'urls', rowsCount = 5, className = '' }) {
  ...
  if (variant === 'visits') {
    return (
      <div className={`w-full overflow-hidden rounded-none border-2 border-primary bg-white shadow-brutal-sm ${className}`}>
        <div className="border-b-2 border-primary bg-surface-container-low p-4 flex gap-4">
  ...
  if (variant === 'bulk') {
    return (
      <div className={`w-full overflow-hidden rounded-none border-2 border-primary bg-white shadow-brutal-sm ${className}`}>
        <div className="border-b-2 border-primary bg-surface-container-low p-4 flex justify-between">
  ...
  return (
    <div className={`w-full overflow-hidden rounded-none border-2 border-primary bg-white shadow-brutal-sm ${className}`}>
      <div className="border-b-2 border-primary bg-surface-container-low p-4 flex justify-between items-center">
